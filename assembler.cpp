...
unordered_map<string, function<string(const Instruction &)>> instructionTable = {
    ...
    {"and", [](const Instruction &instr)
     {
         int rs = getRegisterNumber(instr.operands[1]);
         int rt = getRegisterNumber(instr.operands[2]);
         int rd = getRegisterNumber(instr.operands[0]);
         return "000000" + toBinary(rs, 5) + toBinary(rt, 5) + toBinary(rd, 5) + "00000100100";
     }},
    ...
    {"or", [](const Instruction &instr)
     {
         int rs = getRegisterNumber(instr.operands[1]);
         int rt = getRegisterNumber(instr.operands[2]);
         int rd = getRegisterNumber(instr.operands[0]);
         return "000000" + toBinary(rs, 5) + toBinary(rt, 5) + toBinary(rd, 5) + "00000100101";
     }},
    ...
    {"xor", [](const Instruction &instr)
     {
         int rs = getRegisterNumber(instr.operands[1]);
         int rt = getRegisterNumber(instr.operands[2]);
         int rd = getRegisterNumber(instr.operands[0]);
         return "000000" + toBinary(rs, 5) + toBinary(rt, 5) + toBinary(rd, 5) + "100110";
     }},
    ...
    {"nor", [](const Instruction &instr)
     {
         int rs = getRegisterNumber(instr.operands[1]);
         int rt = getRegisterNumber(instr.operands[2]);
         int rd = getRegisterNumber(instr.operands[0]);
         return "000000" + toBinary(rs, 5) + toBinary(rt, 5) + toBinary(rd, 5) + "100111";
     }},
    ...
    {"lb", [](const Instruction &instr)
     {
         int base = getRegisterNumber(instr.operands[3]);
         int rt = getRegisterNumber(instr.operands[0]);
         int offset = stoi(instr.operands[1]);
         return "100000" + toBinary(base, 5) + toBinary(rt, 5) + toBinary(offset, 16);
     }},
    {"lbu", [](const Instruction &instr)
     {
         int base = getRegisterNumber(instr.operands[3]);
         int rt = getRegisterNumber(instr.operands[0]);
         int offset = stoi(instr.operands[1]);
         return "100100" + toBinary(base, 5) + toBinary(rt, 5) + toBinary(offset, 16);
     }},
    {"lh", [](const Instruction &instr)
     {
         int base = getRegisterNumber(instr.operands[3]);
         int rt = getRegisterNumber(instr.operands[0]);
         int offset = stoi(instr.operands[1]);
         return "100001" + toBinary(base, 5) + toBinary(rt, 5) + toBinary(offset, 16);
     }},
    {"lhu", [](const Instruction &instr)
     {
         int base = getRegisterNumber(instr.operands[3]);
         int rt = getRegisterNumber(instr.operands[0]);
         int offset = stoi(instr.operands[1]);
         return "100101" + toBinary(base, 5) + toBinary(rt, 5) + toBinary(offset, 16);
     }},
    {"sb", [](const Instruction &instr)
     {
         int base = getRegisterNumber(instr.operands[3]);
         int rt = getRegisterNumber(instr.operands[0]);
         int offset = stoi(instr.operands[1]);
         return "101000" + toBinary(base, 5) + toBinary(rt, 5) + toBinary(offset, 16);
     }},
    {"sh", [](const Instruction &instr)
     {
         int base = getRegisterNumber(instr.operands[3]);
         int rt = getRegisterNumber(instr.operands[0]);
         int offset = stoi(instr.operands[1]);
         return "101001" + toBinary(base, 5) + toBinary(rt, 5) + toBinary(offset, 16);
     }},
    {"sll", [](const Instruction &instr)
     {
         int rd = getRegisterNumber(instr.operands[0]);
         int rt = getRegisterNumber(instr.operands[1]);
         int sa = stoi(instr.operands[2]);
         return "00000000000" + toBinary(rt, 5) + toBinary(rd, 5) + toBinary(sa, 5) + "000000";
     }},
    {"srl", [](const Instruction &instr)
     {
         int rd = getRegisterNumber(instr.operands[0]);
         int rt = getRegisterNumber(instr.operands[1]);
         int sa = stoi(instr.operands[2]);
         return "00000000000" + toBinary(rt, 5) + toBinary(rd, 5) + toBinary(sa, 5) + "000010";
     }},
    {"sla", [](const Instruction &instr)
     {
         int rd = getRegisterNumber(instr.operands[0]);
         int rt = getRegisterNumber(instr.operands[1]);
         int sa = stoi(instr.operands[2]);
         return "00000000000" + toBinary(rt, 5) + toBinary(rd, 5) + toBinary(sa, 5) + "000011";
     }},
    {"sllv", [](const Instruction &instr)
     {
         int rs = getRegisterNumber(instr.operands[1]);
         int rt = getRegisterNumber(instr.operands[2]);
         int rd = getRegisterNumber(instr.operands[0]);
         return "000000" + toBinary(rs, 5) + toBinary(rt, 5) + toBinary(rd, 5) + "000100";
     }},
    {"srlv", [](const Instruction &instr)
     {
         int rs = getRegisterNumber(instr.operands[1]);
         int rt = getRegisterNumber(instr.operands[2]);
         int rd = getRegisterNumber(instr.operands[0]);
         return "000000" + toBinary(rs, 5) + toBinary(rt, 5) + toBinary(rd, 5) + "000110";
     }},
    {"srav", [](const Instruction &instr)
     {
         int rs = getRegisterNumber(instr.operands[1]);
         int rt = getRegisterNumber(instr.operands[2]);
         int rd = getRegisterNumber(instr.operands[0]);
         return "000000" + toBinary(rs, 5) + toBinary(rt, 5) + toBinary(rd, 5) + "000111";
     }},
};
